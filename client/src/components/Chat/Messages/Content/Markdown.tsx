...
const Markdown = memo(({ content = '', isLatestMessage, endpoint }: TContentProps) => {
  ...
  const remarkPlugins: Pluggable[] = useMemo(() => {
    ...
    // Only add unicodeCitation for non-assistant endpoints
    const isAssistantEndpoint = endpoint === EModelEndpoint.assistants || endpoint === EModelEndpoint.azureAssistants;
