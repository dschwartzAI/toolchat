...
export const alternateName = {
  ...
  [EModelEndpoint.assistants]: 'Coaches',
  [EModelEndpoint.agents]: 'Tools',
...
export enum CacheKeys {
  ...
  /**
   * Key for OpenID session cache
   */
  OPENID_SESSION = 'openid_session',
  /**
   * Key for SAML session cache
   */
